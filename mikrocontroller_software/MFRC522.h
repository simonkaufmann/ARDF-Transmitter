...
#include <SPI.h>
	...
	/////////////////////////////////////////////////////////////////////////////////////
	void MFRC522_init(byte chipSelectPin, byte resetPowerDownPin);
	...
	void PCD_WriteRegister_pointer(byte reg, byte count, byte *values);
	byte PCD_ReadRegister_one(byte reg);
	void PCD_ReadRegister_three(byte reg, byte count, byte *values);
	...
	byte PCD_TransceiveData_four(byte *sendData, byte sendLen, byte *backData, byte *backLen);
	byte PCD_TransceiveData_five(byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits);
	byte PCD_TransceiveData_six(byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits, byte rxAlign);
	...
	byte PCD_CommunicateWithPICC_four(byte command, byte waitIRq, byte *sendData, byte sendLen);
	byte PCD_CommunicateWithPICC_seven(byte command, byte waitIRq, byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits);
	...
	byte PCD_MIFARE_Transceive_second(byte *sendData, byte sendLen);
